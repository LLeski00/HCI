    ...
    const steps = [
        {
            ...
            description: "Fill in your travel dates, number of people, budget range, and where you're starting from.",
        },
        {
            title: "Step 2: We Find Your Perfect Ski Getaway",
            description: "Our system analyzes hundreds of options to match you with: closest locations, most affordable deals, and highest-rated resorts based on your criteria.",
        },
        {
