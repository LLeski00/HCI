        ...
        <div className="">
            ...
            <div className="home-section">
                <div className="text-content">
                    ...
                    <p>
                        Embark on your next snowy adventure with ease! Discover
                        top ski resorts in Europe, compare features, and plan
                        your dream trip—all in one place. From family-friendly
                        slopes to thrilling alpine runs, we have everything you
                        need to make your ski vacation unforgettable. Start
                        exploring today!
                    </p>
            ...
            <div className="home-destinations-section">
